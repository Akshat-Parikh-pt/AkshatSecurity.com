...
import {
    Mail, Linkedin, Menu, X, ShieldCheck, Download, Briefcase, ArrowDown,
    Shield, Search, UserCheck, Network, GraduationCap, Calendar, ArrowRight,
    CheckCircle, Swords, Globe, Box, BrainCircuit, Book,
    HeartHandshake, TrendingUp, Focus, ScanSearch, FileText, Star, FileSpreadsheet,
...
const GlobalStyles = () => (
    <style>{`
        ...
        .styled-card, .certificate-card, .education-card, .methodology-card, .service-card, .faq-item {
        ...
        .styled-card:hover, .certificate-card:hover, .education-card:hover, .methodology-card:hover, .faq-item:hover {
        ...
        .cert-modal-overlay, .privacy-modal-overlay {
            position: fixed;
            top: 0;
            left: 0;
            width: 100vw;
        ...
        .icon-hover-effect-container:hover .icon-hover-effect {
            transform: scale(1.1);
    ...
    return (
        <div className="privacy-modal-overlay" onClick={onClose}>
            <div className="privacy-modal-content" onClick={(e) => e.stopPropagation()}>
                ...
                <h2 className="text-2xl font-bold mb-4 accent-green">Privacy Policy</h2>
                <div className="space-y-4 text-text-secondary">
                    <p>Effective Date: October 17, 2025</p>
                    <p>This Privacy Policy describes how Akshat Parikh (“we”, “us”, or “our”) collects, uses, and protects personal information you provide when you use our website.</p>
                    <p>We take privacy seriously and only collect the minimum data necessary to respond to your inquiries or provide requested information.</p>
                    <div>
                        <h3 className="text-xl font-bold mb-2 text-text-primary">1. What we collect</h3>
                        <p>We do not use cookies, analytics, tracking tools, or collect any information automatically. We only collect personal information when you voluntarily send it via our contact form. This may include:</p>
                        <ul className="list-disc list-inside pl-4 mt-2">
                            <li>Your name</li>
                            <li>Your email address</li>
                            <li>Any message or file you send us</li>
                        </ul>
                        <p className="mt-2">The contact form on our website is powered by Formspree, a third-party form service. When you submit the form, your message is securely transmitted and stored by Formspree so we can respond to your inquiry. We recommend you do not include any sensitive information in the message field.</p>
                    </div>
                    <div>
                        <h3 className="text-xl font-bold mb-2 text-text-primary">2. How we use your information</h3>
                        <p>We use your information solely to:</p>
                        <ul className="list-disc list-inside pl-4 mt-2">
                            <li>Respond to your inquiries</li>
                            <li>Provide requested information</li>
                            <li>Communicate about potential services (if applicable)</li>
                        </ul>
                        <p className="mt-2">We do not sell, rent, or share your personal information with third parties for marketing purposes.</p>
                    </div>
                    <div>
                        <h3 className="text-xl font-bold mb-2 text-text-primary">3. Who we share data with</h3>
                        <p>We may share your data only with:</p>
                        <ul className="list-disc list-inside pl-4 mt-2">
                            <li>Formspree, our form processor (see <a href="https://formspree.io/legal/privacy-policy/" target="_blank" rel="noopener noreferrer" className="accent-green hover:underline">Formspree’s privacy policy here</a>)</li>
                            <li>Law enforcement or legal authorities, only if required by law</li>
                        </ul>
                    </div>
                     <div>
                        <h3 className="text-xl font-bold mb-2 text-text-primary">4. How we protect your data</h3>
                        <p>We take appropriate technical and organizational measures to protect your personal information, including:</p>
                        <ul className="list-disc list-inside pl-4 mt-2">
                            <li>Using SSL encryption on our website (HTTPS)</li>
                            <li>Limiting access to any submitted messages</li>
                            <li>Not storing data longer than necessary to respond</li>
                        </ul>
                    </div>
                     <div>
                        <h3 className="text-xl font-bold mb-2 text-text-primary">5. Data retention</h3>
                        <p>We only keep your messages for as long as needed to respond to you or maintain professional communication, unless legally required to retain them longer.</p>
                    </div>
                     <div>
                        <h3 className="text-xl font-bold mb-2 text-text-primary">6. Your rights</h3>
                        <p>Depending on your location, you may have rights under privacy laws such as:</p>
                         <ul className="list-disc list-inside pl-4 mt-2">
                            <li>Access to the personal data we have about you</li>
                            <li>Request deletion or correction of your data</li>
                            <li>Object to or limit our use of your data</li>
                        </ul>
                        <p className="mt-2">To request any of the above, contact us using the email below.</p>
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <p>We may update this Privacy Policy if our practices change. The latest version will always be available on this page.</p>
                    </div>
                    <div className="mt-6 p-4 bg-dark-bg rounded-lg border border-border-color">
                        <h3 className="font-bold text-text-primary">TL;DR:</h3>
                        <p>We only collect info you send us through the contact form. We don’t track you, use cookies, or share your info. You can contact us anytime to request deletion or ask questions.</p>
                    </div>
                </div>
            </div>
        </div>
...
export default function App() {
    ...
    const handleContactSubmit = async (e) => {
        ...
        try {
            const response = await fetch("https://formspree.io/f/mnnglrze", {
                method: 'POST',
                body: data,
                headers: {
            ...
            if (response.ok) {
                ...
                setToastMessage("Oops! There was a problem submitting your form.");
            }
        } catch (error) {
            setToastMessage("Oops! There was a problem submitting your form.");
        }
    ...
    return (
        <div className="app-container">
            ...
            <header id="header" className="fixed top-0 left-0 right-0 z-50">
                <nav className="container mx-auto px-6 flex justify-between items-center">
                    ...
                    <div className="hidden md:flex items-center space-x-1">
                        {navItems.map(item => (
                            <a key={item} href={`#${item.toLowerCase()}`} onClick={(e) => handleNavLinkClick(e, item.toLowerCase())} className={`nav-link rounded-md capitalize ${activeNav === item.toLowerCase() ? 'active-nav-button' : ''}`}>
                                {item}
                            </a>
                        ))}
                    </div>
                    <div className="hidden md:flex items-center space-x-4">
                        ...
                        <a href="https://www.linkedin.com/in/akshatparikh-pt/" target="_blank" rel="noopener noreferrer" className="text-[var(--primary-green)] hover:text-[var(--light-green)] transition-colors duration-300" aria-label="LinkedIn"><Linkedin className="w-6 h-6" /></a>
                        <a href="https://tryhackme.com/p/SN1PER" target="_blank" rel="noopener noreferrer" className="text-[var(--primary-green)] hover:text-[var(--light-green)] transition-colors duration-300 p-1" aria-label="TryHackMe">
                            <img src={tryhackmeLogoPng} alt="TryHackMe" className="w-6 h-6" />
                        </a>
                        <a href="https://app.hackthebox.com/users/475852" target="_blank" rel="noopener noreferrer" className="text-[var(--primary-green)] hover:text-[var(--light-green)] transition-colors duration-300" aria-label="HackTheBox"><Box className="w-6 h-6" /></a>
                    </div>
            ...
            <main>
                <section id="home" ref={sectionRefs.home} className="min-h-screen flex flex-col items-center justify-start px-6 relative overflow-hidden">
                    ...
                    <div className="flex-grow flex flex-col justify-center items-center pt-20 pb-6 relative z-10 w-full">
                        ...
                        <div className="mt-10 flex flex-col sm:flex-row justify-center items-center space-y-4 sm:space-y-0 sm:space-x-4 fade-in-up reveal delay-4 w-full">
                            ...
                            <a href="/Akshat Parikh Resume.pdf" download="Akshat Parikh Resume.pdf" className="btn btn-secondary px-6 py-2.5 rounded-lg flex items-center justify-center space-x-2 w-full sm:w-auto"><Download className="w-4 h-4" /><span>Download Resume</span></a>
                        </div>
                    </div>
                ...
                <section id="services" ref={sectionRefs.services} className="py-24 w-full">
                    <div className="container mx-auto px-6">
                        <div className="text-center mb-12 reveal">
                            ...
                            <h3 className="text-xl text-text-secondary mt-4">Expert in Web Application, Network, and Vulnerability Assessments.</h3>
                            ...
                            <div className="service-card service-card-highlight p-8 rounded-lg reveal h-full flex flex-col">
                                ...
                                <div className="flex flex-col flex-grow">
                                    <div>
                                        ...
                                        <ul className="space-y-1.5 text-sm text-text-secondary pl-2">
                                            <li className="flex items-start">
                                                ...
                                                <span>
                                                    ...
                                                    <span className={`details-text ${coveredDetailsVisible ? 'visible' : ''}`}> Automated security scans of web applications, find common misconfigurations and known software vulnerabilities.</span>
                                                </span>
                                            </li>
                                            <li className="flex items-start">
                                                <CheckCircle className="w-4 h-4 mr-2 mt-1 accent-green flex-shrink-0" />
                                                <span>
                                                    ...
                                                    <span className={`details-text ${coveredDetailsVisible ? 'visible' : ''}`}> Light manual review for misconfigurations or overlooked issues</span>
                                                </span>
                                            </li>
                                            <li className="flex items-start">
                                                <CheckCircle className="w-4 h-4 mr-2 mt-1 accent-green flex-shrink-0" />
                                                <span>
                                                    ...
                                                    <span className={`details-text ${coveredDetailsVisible ? 'visible' : ''}`}> I manually validate the most critical findings to ensure the report is accurate and free of false positives.</span>
                                                </span>
                                            </li>
                                             <li className="flex items-start">
                                                <CheckCircle className="w-4 h-4 mr-2 mt-1 accent-green flex-shrink-0" />
                                                <span>
                                                    ...
                                                    <span className={`details-text ${coveredDetailsVisible ? 'visible' : ''}`}>, exposed admin panels, and other common threats</span>
                                                </span>
                                            </li>
                                        </ul>
                                    </div>
                                        ...
                                        <ul className="space-y-1.5 text-sm text-text-secondary pl-2">
                                            <li className="flex items-start">
                                                ...
                                                <span>
                                                    ...
                                                    <span className={`details-text ${coveredDetailsVisible ? 'visible' : ''}`}> Full vulnerability assessment plus in-depth manual penetration testing</span>
                                                </span>
                                            </li>
                                             <li className="flex items-start">
                                                <CheckCircle className="w-4 h-4 mr-2 mt-1 accent-green flex-shrink-0" />
                                                <span>
                                                    ...
                                                    <span className={`details-text ${coveredDetailsVisible ? 'visible' : ''}`}> Simulating how a real hacker would try to steal customer data, compromise user accounts, or gain admin access.</span>
                                                </span>
                                            </li>
                                             <li className="flex items-start">
                                                <CheckCircle className="w-4 h-4 mr-2 mt-1 accent-green flex-shrink-0" />
                                                <span>
                                                    ...
                                                    <span className={`details-text ${coveredDetailsVisible ? 'visible' : ''}`}> Testing of authentication mechanisms, user roles, session management, and data handling</span>
                                                </span>
                                            </li>
                                            <li className="flex items-start">
                                                <CheckCircle className="w-4 h-4 mr-2 mt-1 accent-green flex-shrink-0" />
                                                <span>
                                                    ...
                                                    <span className={`details-text ${coveredDetailsVisible ? 'visible' : ''}`}> Identifying critical vulnerabilities like SQL Injection, Cross-Site Scripting (XSS), and Broken Access Control</span>
                                                </span>
                                            </li>
                                        </ul>
                                    </div>
                                        ...
                                        <ul className="space-y-1.5 text-sm text-text-secondary pl-2">
                                            <li className="flex items-start">
                                                ...
                                                <span>
                                                    ...
                                                    <span className={`details-text ${coveredDetailsVisible ? 'visible' : ''}`}> I'll scan your internet-facing systems to identify exposed services, weak firewall rules, and open ports that are visible to attackers online.</span>
                                                </span>
                                            </li>
                                            <li className="flex items-start">
                                                <CheckCircle className="w-4 h-4 mr-2 mt-1 accent-green flex-shrink-0" />
                                                <span>
                                                    ...
                                                    <span className={`details-text ${coveredDetailsVisible ? 'visible' : ''}`}> Looking for weak passwords, unpatched systems, and ways an attacker could move from one machine to another.</span>
                                                </span>
                                            </li>
                                             <li className="flex items-start">
                                                <CheckCircle className="w-4 h-4 mr-2 mt-1 accent-green flex-shrink-0" />
                                                <span>
                                                    ...
                                                    <span className={`details-text ${coveredDetailsVisible ? 'visible' : ''}`}> Identifying out-of-date software and system misconfigurations.</span>
                                                </span>
                                            </li>
                                            <li className="flex items-start">
                                                <CheckCircle className="w-4 h-4 mr-2 mt-1 accent-green flex-shrink-0" />
                                                <span>
                                                    ...
                                                    <span className={`details-text ${coveredDetailsVisible ? 'visible' : ''}`}> A detailed review of how data flows within your network to identify potential weak points or insecure paths that could be exploited by attackers.</span>
                                                </span>
                                            </li>
                                        </ul>
                                    </div>
                        ...
                        <div className="mt-24 reveal">
                            <div className="styled-card p-8 rounded-lg reveal service-card-highlight overflow-hidden">
                                <div className="grid md:grid-cols-12 items-center gap-8 text-center md:text-left">
                                    <div className="md:col-span-3 flex justify-center md:justify-start">
                                         <div className="w-32 h-48 bg-card-bg-hover border-2 border-border-color rounded-lg flex flex-col justify-between p-3 relative shadow-2xl">
                                            <div className="absolute top-0 right-0 w-0 h-0 border-l-24 border-l-card-bg border-t-24 border-t-dark-bg rounded-tr-lg"></div>
                                            <div>
                                                <div className="w-10 h-10">
                                                    <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                                        <defs>
                                                            <filter id="glow-icon-2" x="-50%" y="-50%" width="200%" height="200%" filterUnits="userSpaceOnUse">
                                                                <feGaussianBlur stdDeviation="0.8" result="cBlur" />
                                                                <feMerge>
                                                                    <feMergeNode in="cBlur" />
                                                                    <feMergeNode in="SourceGraphic" />
                                                        ...
                                                        <g filter="url(#glow-icon-2)">
                                                            <path d="M12 22S19 18 19 12V5L12 2L5 5V12C5 18 12 22 12 22Z" stroke="#05c168" strokeWidth="1.4" fill="#000" />
                                                            <g transform="translate(12 12.5) scale(0.8) translate(-12 -12.5)" stroke="#05c168" strokeWidth="1.4" strokeLinecap="round" strokeLinejoin="round">
                                                                <path d="M10.5 11V9.5C10.5 8.67157 11.1716 8 12 8C12.8284 8 13.5 8.67157 13.5 9.5V11" fill="none" />
                                                                <rect x="9" y="11" width="6" height="5" rx="1" fill="none" />
                                                                <path d="M12 13.5V13.5" strokeWidth="2" />
                                                            </g>
                                                        </g>
                                                    </svg>
                                                </div>
                                                <p className="text-sm font-bold mt-2 accent-green">Akshat Parikh</p>
                                            </div>
                                            <div>
                                                <div className="h-1.5 w-full bg-border-color rounded-full my-1"></div>
                                                <div className="h-1.5 w-3/4 bg-border-color rounded-full my-1"></div>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="md:col-span-9">
                                        <h3 className="text-2xl font-bold">Download My Resources</h3>
                                        <p className="text-text-secondary mt-2 mb-6">Take the next step in securing your business. Download these resources to gain a deeper insight into my process, see the quality of my reports, and review my professional background.</p>
                                        <div className="flex flex-col sm:flex-row items-center md:items-start gap-4">
                                            <a href="/Penetration Testing Services Brochure - Akshat Parikh.pdf" download="Penetration Testing Services Brochure - Akshat Parikh.pdf" className="btn btn-primary btn-primary-pulse px-6 py-2.5 rounded-lg flex items-center justify-center space-x-2 text-base w-full sm:w-auto"><Download className="w-5 h-5" /><span>Download Brochure</span></a>
                                            <a href="/Sample Pen-Test Report.pdf" download="Sample Pen-Test Report.pdf" className="btn btn-secondary px-6 py-2.5 rounded-lg flex items-center justify-center space-x-2 text-base w-full sm:w-auto"><FileText className="w-5 h-5" /><span>Download Sample Report</span></a>
                                            <a href="/Akshat Parikh Resume.pdf" download="Akshat Parikh Resume.pdf" className="btn btn-secondary px-6 py-2.5 rounded-lg flex items-center justify-center space-x-2 text-base w-full sm:w-auto"><UserCheck className="w-5 h-5" /><span>Download Resume</span></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="mt-24 reveal">
                            <div className="text-center mb-12">
                                <h2 className="text-4xl font-bold">Why <span className="accent-green">Partner</span> With Me?</h2>
                                <p className="mt-4 max-w-2xl mx-auto text-text-secondary">The core benefits of a professional, expert-led security partnership.</p>
                            </div>
                            <div className="grid md:grid-cols-2 gap-x-8 gap-y-10">
                                <div className="icon-hover-effect-container flex items-start gap-4 reveal">
                                    <div className="bg-dark-green-bg p-3 rounded-full border border-border-color icon-hover-effect">
                                        <ShieldCheck className="w-6 h-6 accent-green" />
                                    </div>
                                    <div>
                                        <h4 className="text-lg font-bold">Safeguard Your Brand & Reputation</h4>
                                        <p className="text-text-secondary mt-1">A security breach can destroy customer trust; a professional pentest is your best defense.</p>
                                    </div>
                                </div>
                                <div className="icon-hover-effect-container flex items-start gap-4 reveal delay-1">
                                    <div className="bg-dark-green-bg p-3 rounded-full border border-border-color icon-hover-effect">
                                        <HeartHandshake className="w-6 h-6 accent-green" />
                                    </div>
                                    <div>
                                        <h4 className="text-lg font-bold">Maintain Customer Trust & Loyalty</h4>
                                        <p className="text-text-secondary mt-1">Show your customers you value their security by proactively protecting their sensitive data.</p>
                                    </div>
                                </div>
                                <div className="icon-hover-effect-container flex items-start gap-4 reveal delay-2">
                                    <div className="bg-dark-green-bg p-3 rounded-full border border-border-color icon-hover-effect">
                                        <TrendingUp className="w-6 h-6 accent-green" />
                                    </div>
                                    <div>
                                        <h4 className="text-lg font-bold">Uncover Hidden Business Risks</h4>
                                        <p className="text-text-secondary mt-1">I identify technical flaws that could lead to financial loss, operational downtime, or data theft.</p>
                                    </div>
                                </div>
                                <div className="icon-hover-effect-container flex items-start gap-4 reveal delay-3">
                                    <div className="bg-dark-green-bg p-3 rounded-full border border-border-color icon-hover-effect">
                                        <BrainCircuit className="w-6 h-6 accent-green" />
                                    </div>
                                    <div>
                                        <h4 className="text-lg font-bold">Expert-Led Penetration Testing</h4>
                                        <p className="text-text-secondary mt-1">Leverage my CRTA certification and Top 0.1% ranking to receive a test that goes far beyond automated scans.</p>
                                    </div>
                                </div>
                                <div className="icon-hover-effect-container flex items-start gap-4 reveal delay-4">
                                    <div className="bg-dark-green-bg p-3 rounded-full border border-border-color icon-hover-effect">
                                        <FileText className="w-6 h-6 accent-green" />
                                    </div>
                                    <div>
                                        <h4 className="text-lg font-bold">Professional & Actionable Reporting</h4>
                                        <p className="text-text-secondary mt-1">You get a clear report that explains risks in business terms, not just technical jargon.</p>
                                    </div>
                                </div>
                                <div className="icon-hover-effect-container flex items-start gap-4 reveal delay-5">
                                    <div className="bg-dark-green-bg p-3 rounded-full border border-border-color icon-hover-effect">
                                        <Focus className="w-6 h-6 accent-green" />
                                    </div>
                                    <div>
                                        <h4 className="text-lg font-bold">Remediation Guidance & Consultation</h4>
                                        <p className="text-text-secondary mt-1">I provide ongoing support to ensure your team understands the findings and can implement fixes effectively.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <section id="process" ref={sectionRefs.process} className="py-24 w-full">
                    <div className="container mx-auto px-6">
                         <div className="text-center mb-16 reveal">
                            ...
                            <p className="mt-4 max-w-2xl mx-auto text-text-secondary">A transparent, five-step process designed to deliver clear, actionable results, ensuring you understand every stage of the engagement.</p>
                             <p className="mt-8 max-w-3xl mx-auto text-center text-lg italic text-text-secondary reveal">
                                "I believe effective security is a partnership. My process is built on clear communication, contextualizing technical risks into real-world business impact to empower your team to build a more secure future."
                            </p>
                        </div>
                        ...
                        <div className="relative">
                            ...
                            <div className="grid md:grid-cols-2 gap-16 items-center mb-24 relative reveal z-20">
                                ...
                                <div className="process-step-content text-left text-center md:text-left pl-12">
                                    ...
                                    <ul className="space-y-2 text-text-secondary list-disc list-inside md:list-none">
                                        ...
                                        <li>Contextualize vulnerabilities, explaining their real-world business impact so you can prioritize the risks that matter most.</li>
                                    </ul>
                                </div>
                                <div className="flex items-center justify-center p-4">
                                <svg viewBox="0 0 200 200" className="w-full max-w-sm">
                            ...
                            <div className="grid md:grid-cols-2 gap-16 items-center mb-24 relative reveal z-20">
                                ...
                                <div className="process-step-content text-right text-center md:text-right pr-12">
                                    ...
                                    <p className="text-text-secondary mb-6">The engagement concludes with a deliverable designed for all stakeholders. You receive an executive summary for leadership and a detailed technical report with clear, prioritized remediation steps for your development team. I also provide consultation to ensure your team understands the findings and can implement fixes.</p>
                                    <div className="flex flex-col items-center md:items-end">
                                        ...
                                        <a href="/Sample Pen-Test Report.pdf" download="Sample Pen-Test Report.pdf" className="btn btn-primary px-6 py-2.5 rounded-lg flex items-center justify-center space-x-2 mt-6"><Download className="w-4 h-4" /><span>Download Sample Report</span></a>
                                    </div>
                                </div>
                            </div>
                            {/* Step 5 */}
                            <div className="grid md:grid-cols-2 gap-16 items-center relative reveal z-20">
                                <div className="hidden md:block absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 h-24 w-0.5 bg-[var(--primary-green)] shadow-[0_0_10px_var(--glow-color)]"></div>
                                 <div className="process-step-content text-left text-center md:text-left pl-12">
                                    <h3 className="text-2xl font-bold mb-3"><span className="accent-green">5.</span> Remediation & Retesting</h3>
                                    <ul className="space-y-2 text-text-secondary list-disc list-inside md:list-none">
                                        <li>Provide ongoing support to your development team to ensure they understand the findings and can implement fixes correctly.</li>
                                        <li>Review implemented patches and fixes to confirm they effectively mitigate the identified vulnerabilities.</li>
                                        <li>Offer a <span className="font-semibold accent-green">complimentary re-test</span> for any critical or high-risk vulnerabilities to verify they have been fully resolved.</li>
                                        <li>Ensure your team is confident in the security posture of the application or network post-engagement.</li>
                                    </ul>
                                </div>
                                <div className="flex items-center justify-center p-4">
                                <svg viewBox="0 0 200 200" className="w-full max-w-sm">
                                    <path d="M 60,60 L 140,140 M 60,140 L 140,60" stroke="var(--primary-green)" strokeWidth="1" opacity="0.2"/>
                                    <path d="M100 20 A 80 80 0 1 1 100 180 A 80 80 0 1 1 100 20" stroke="var(--primary-green)" strokeWidth="1.5" fill="none" opacity="0.5" />
                                    <polyline points="75,100 95,120 125,80" stroke="var(--light-green)" strokeWidth="8" strokeLinecap="round" strokeLinejoin="round" fill="none"/>
                                    <text x="100" y="170" textAnchor="middle" fill="var(--primary-green)" fontSize="10" fontWeight="bold">VERIFIED</text>
                                </svg>
                                </div>
                            </div>
                        </div>
                ...
                <section id="achievements" ref={sectionRefs.achievements} className="py-24 w-full">
                    <div className="container mx-auto px-6">
                        ...
                        <div className="grid lg:grid-cols-2 gap-8 mb-8">
                            <div className="styled-card p-8 rounded-lg reveal flex flex-col space-y-6"><div className="flex justify-between items-start"><div className="flex items-center space-x-4"><img src={tryhackmeLogoPng} alt="TryHackMe" className="w-10 h-10" /><div><h3 className="text-xl font-bold">TryHackMe</h3><p className="text-sm text-text-secondary">Known as <span className="accent-green font-semibold">SN1PER</span></p></div></div><span className="achievement-badge text-xs font-semibold px-3 py-1 rounded-full">Top 0.1%</span></div><p className="text-text-secondary">Elite ranking among global cybersecurity enthusiasts, actively participating in CTFs and learning paths.</p><div className="thm-badge-iframe"><iframe title="TryHackMe Profile Badge" src="https://tryhackme.com/api/v2/badges/public-profile?userPublicId=3454390" style={{width: '100%', height: '100%', border: 'none'}}></iframe></div><div className="grid grid-cols-3 gap-4 text-center border-t border-gray-700 pt-4"><div><p className="text-2xl font-bold accent-green">Top 0.1%</p><p className="text-xs text-text-secondary">Global Rank</p></div><div><p className="text-2xl font-bold accent-green">400+</p><p className="text-xs text-text-secondary">Day Streaks</p></div><div><p className="text-2xl font-bold accent-green">200+</p><p className="text-xs text-text-secondary">CTF Challenges</p></div></div></div>
                ...
                <section id="faqs" ref={sectionRefs.faqs} className="py-24 w-full">
                    <div className="container mx-auto px-6">
                        <div className="text-center mb-12 reveal">
                            <h2 className="text-4xl font-bold">Frequently Asked <span className="accent-green">Questions</span></h2>
                        </div>
                            ...
                            <div className="styled-card p-8 rounded-lg reveal flex flex-col">
                                ...
                                <form onSubmit={handleContactSubmit} className="space-y-4">
                                    <div className="grid sm:grid-cols-2 gap-4">
                                        <div><label htmlFor="name" className="text-sm font-medium sr-only">Name</label><input type="text" id="name" name="name" placeholder="Name *" required className="contact-form-input mt-1 w-full bg-dark-bg border border-gray-700 rounded-lg px-3 py-2 focus:ring-1 focus:ring-primary-green focus:outline-none" /></div>
                                        <div><label htmlFor="email" className="text-sm font-medium sr-only">Email</label><input type="email" id="email" name="email" placeholder="Email *" required className="contact-form-input mt-1 w-full bg-dark-bg border border-gray-700 rounded-lg px-3 py-2 focus:ring-1 focus:ring-primary-green focus:outline-none" /></div>
                                    </div>
                                    <div>
                                        <label htmlFor="message" className="text-sm font-medium sr-only">Message</label>
                                        <textarea id="message" name="message" rows="4" placeholder="Message *" required className="contact-form-input mt-1 w-full bg-dark-bg border border-gray-700 rounded-lg px-3 py-2 focus:ring-1 focus:ring-primary-green focus:outline-none"></textarea>
                                    </div>
                                    <button type="submit" className="btn btn-primary w-full py-2.5 rounded-lg">Request My Free Consultation</button>
                                </form>
                                <div className="mt-4 text-center text-text-secondary text-sm">
                                    <p className="font-semibold accent-green">&lt; 12hrs</p>
                                    <p>Average Response Time</p>
                                </div>
                                <div className="mt-6 text-xs text-text-secondary flex items-start text-center gap-2 border-t border-border-color pt-4">
                                    <Lock size={28} className="accent-green flex-shrink-0" />
                                    <span>Your security and confidentiality are paramount. All engagement details and findings are held in the strictest of confidence. I am fully prepared to sign an NDA prior to any engagement.</span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div className="container mx-auto px-6 py-12">
                    ...
                    <div className="mt-12 border-t border-gray-800 pt-6 flex flex-col md:flex-row justify-between items-center text-center md:text-left">
                        <div className="flex items-center gap-4">
                             <p className="text-sm text-text-secondary">&copy; 2025 Akshat Parikh. All Rights Reserved.</p>
                             <a href="#" onClick={(e) => {e.preventDefault(); setIsPrivacyModalOpen(true);}} className="text-sm text-text-secondary hover:text-white">Privacy Policy</a>
                        </div>
                        <p className="text-sm text-text-secondary mt-2 md:mt-0">Proactive Security Through Offensive Expertise</p>
                    </div>
                </div>
            </footer>
            ...
            <div id="notification-toast" className={`bg-primary-green text-dark-bg font-semibold px-6 py-3 rounded-lg shadow-lg ${showToast ? 'show' : ''}`}>{toastMessage}</div>
        </div>
    );
}
...
const faqs = [
    { 
        ...
        a: "Penetration testing (or 'pentesting') is a proactive security service that simulates a real-world cyberattack on your digital assets. It's crucial because it uncovers hidden vulnerabilities in your systems, applications, or networks before malicious attackers can find and exploit them, protecting your customer data, financial stability, and brand reputation." 
    },
    { 
        q: "Is penetration testing safe for my systems?", 
        a: "Yes, completely. My process is designed to be non-disruptive. All tests are performed in a controlled and safe manner, with clear communication and coordination to ensure your services remain stable. Live production testing is typically scheduled during off-peak hours to eliminate any risk to your business operations." 
    },
    { 
        q: "How long does a penetration test take?", 
        a: "The timeline depends on the complexity and scope of the engagement. A focused Vulnerability Assessment might take 2-3 days, while a comprehensive Web Application or Network Pentest typically ranges from one to two weeks. We will establish a clear and definite timeline during our initial scoping call." 
    },
    { 
        q: "How much does a penetration test cost?", 
        a: "Pricing varies based on the scope, type of test, and size of the environment. I offer flexible and competitive pricing, and I encourage you to contact me for a tailored quote." 
    },
    { 
        q: "Do you offer retesting after vulnerabilities are fixed?", 
        a: "Yes. After your team has remediated the findings, my service includes a complimentary re-test for all identified critical and high-risk vulnerabilities. This verification step is crucial to ensure the fixes are effective and your systems are truly secure." 
    },
    { 
        q: "Will my data be kept confidential?", 
        a: "Confidentiality is my highest priority. All communications, findings, and client data are treated with the strictest confidence. I am fully prepared to sign a Non-Disclosure Agreement (NDA) before any engagement begins to ensure your complete peace of mind." 
    }
];
...
const FAQItem = ({ q, a }) => {
    ...
    return (
        <div className="faq-item rounded-lg">
            <button onClick={() => setIsOpen(!isOpen)} className="w-full text-left p-6 flex justify-between items-center transition-colors duration-300 hover:bg-card-bg-hover">
            ...
            <div className={`overflow-hidden transition-all duration-500 ease-in-out ${isOpen ? 'max-h-96' : 'max-h-0'}`}>
                <p className="px-6 pb-6 text-text-secondary">{a}</p>
            </div>
        </div>
    );
};
